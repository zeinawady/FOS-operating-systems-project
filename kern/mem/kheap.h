...
// Kernel Heap management variables
uint32 kheapStart;      // Start address of the kernel heap
uint32 kheapBreak;      // Current end of the allocated space (segment break)
uint32 kheapHardLimit; // Maximum address the heap can grow to
